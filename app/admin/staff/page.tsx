...
type Staff={id:number;firstName:string;lastName:string;email:string;phone:string|null;role:"STAFF"|"ADMIN"|"SUPER_ADMIN";homeBranchId:number|null;isActive:boolean;twoFactorEnabled:boolean};type Store={id:number;name:string};
