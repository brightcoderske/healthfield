...
export default async function AdminWalkInSalesPage(){await requireRole(["ADMIN","SUPER_ADMIN"]);const data=await backendJson<Data>("/v1/views/walk-in-sale");return <WalkInSaleForm {...data} backHref="/admin"/>}
