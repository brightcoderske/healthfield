...
export function InventoryManager({initialProducts,backHref="/admin",scopeLabel="every store",canEdit=true}:{initialProducts:Product[];backHref?:string;scopeLabel?:string;canEdit?:boolean}){
