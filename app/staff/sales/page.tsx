...
export default async function StaffSalesPage(){await requireStaffPermission("POS_USE");const data=await backendJson<Data>("/v1/views/walk-in-sale");return <WalkInSaleForm {...data} backHref="/staff"/>}
