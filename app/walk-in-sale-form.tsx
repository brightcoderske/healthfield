...
type SaleState = { orderNumber: string; total: number; state: "WAITING" | "VERIFYING" | "CONFIRMING" | "REVIEWING" | "CANCELLING" | "CANCELLED" | "FAILED" | "COMPLETE"; message: string; candidate?:TillCandidate|null };
